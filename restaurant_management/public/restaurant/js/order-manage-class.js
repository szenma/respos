class OrderManage extends ObjectManage {
    ...
    constructor(options) {
        ...
        this.initialize();
        this.#components.back = RMHelper.default_button("back", 'back', () => this.show_back());
    }
    ...
    make_dom() {
        ...
        this.#components.back = RMHelper.default_button("Back", 'ok', () => this.show_back());
 ...
 this.modal.title_container.empty().append(
    ...
    toggle_main_section(option="items"){
        if(option == "items"){
            this.#components.back.enable().show();
